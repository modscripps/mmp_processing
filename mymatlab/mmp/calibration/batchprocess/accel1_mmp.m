function a=accel1_mmp(ch,drop,mmpid)
% Usage: a=accel1_mmp(ch,drop,mmpid);
%  inputs
...
Sa=0.102; % nominal sensitivity volt/(m s^{-2})
...
elseif strcmp(electronicsid,int2str(3))
  gain=21;  % mmp1,mmp2: drops 2131- , mmp3: drops 2262-
else
