function [Pa1,Pa2,Pv1,Pv2,f]=a1a2v1v2spec_mmp(drop, prstart, prstop,cruise,mmpid)
...
%dmflag='none';
dmflag='mean';
[Pv1,f]=psd(v1,NFFT,400,NFFT,NFFT/2, dmflag);
Pv1 = Pv1 / 200;
[Pa1,f]=psd(a1,NFFT,400,NFFT,NFFT/2, dmflag);
Pa1 = Pa1 / 200;
Ca1v1=cohere(a1,v1,NFFT,400,NFFT, dmflag);
[Pv2,f]=psd(v2,NFFT,400,NFFT,NFFT/2, dmflag);
Pv2 = Pv2 / 200;
[Pa2,f]=psd(a2,NFFT,400,NFFT,NFFT/2, dmflag);
Pa2 = Pa2 / 200;
Ca1v2=cohere(a1,v2,NFFT,400,NFFT, dmflag);

maxPv=max(max(Pv1),max(Pv2)); %%%JJJ;
