...
%          print -dwinc
%       end
      set(gcf,'Position',[5 68 827 737]);
      print('-dpng', fullfile(procdata,cruise,'figs','pdf',[num2str(drop) '_PL1.png']));
      pause(.2); fff1 = gcf;
      ...
      set(gcf,'Position',[10 68 827 737]);
      print('-dpng', fullfile(procdata,cruise,'figs','pdf',[num2str(drop) '_PL2.png']));
      pause(.2)
