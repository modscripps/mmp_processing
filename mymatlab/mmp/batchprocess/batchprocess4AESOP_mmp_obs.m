% batchprocess4AESOP_mmp_obs - rerun for obs offsets (14-aug-06)
...
%    end
   ...
   pause(1)
   continue % verified all drops were processed, none skipped
   disp('whoops!'), pause(5)
   drop_flag=1;
   calc_accel1G_mmp
...
%       end
      ...
      %disp(dstr)
      pause%(5) % to look before continuing during tests
   end
