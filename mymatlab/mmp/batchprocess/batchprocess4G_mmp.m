...
% J. MacKinnon
%modified by DW for HOME cruise 10/00, and by MHA for cross-platform 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   eps_step=1024; % test aug00 vs jul01 (orig used larger window)
   ...
   if 1==1  % skip chi, plotting for now (sc99)
      %calc_tl2_mmp
      ...
      saveas(gcf, [procdata filesep cruise filesep ...
            'figs' filesep 'fig' filesep 'PL1rv_' num2str(drop) '.fig']);
      pause(1)
      ...
      saveas(gcf, [procdata filesep cruise filesep ...
            'figs' filesep 'fig' filesep 'PL2rv_' num2str(drop) '.fig']);
      pause(1)
