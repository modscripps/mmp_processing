function [cs,h]=mmcont3(arg1,arg2,arg3,arg4,arg5)
%MMCONT3 3-D Contour Plot Using a Colormap.
% MMCONT3(X,Y,Z,N,C) plots N contours of Z in 3-D using the color
...
for i=2:nargin	% check input arguments for N and C
	...
	if ~isstr(argi)&length(argi)==1  % must be N, grab it
		n=argi;
		nargs=i;  % # args to pass to contour3
