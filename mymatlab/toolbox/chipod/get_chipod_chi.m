...
% This is the Ocean Mixing Group's function that gets chi for chipods,
% modified Apr-2017 by ECF for use with MMP.
%
% To compute chi and epsilon from chipod data.
%
% Required arguments are:
% - freq bins for dT/dt spectrum
% - the frequencies of tp_spec (dT/dt spectrum),
% - fallspd (in m/s),
% - nu (viscosity),
...
% - alpha (1/rho drho/dT) (default=3e-4) % NEED FOR ARCTIC
...
% - eps_start : Starting guess of epsilon (default=1e-7) % For Arctic,
% let's guess 1e-9
%
