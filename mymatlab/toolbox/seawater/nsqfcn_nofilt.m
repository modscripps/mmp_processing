function [n2,pout,dthetadz,dsdz]=nsqfcn_nofilt(s,t,p,p0,dp)
% nsq
%   Usage: [n2,pout,dthetadz,dsdz]=nsqfcn_nofilt(s,t,p,p0,dp);
...
%Modified from nsqfcn by MHA to NOT filter first.   
G=9.80655;
dz=100*dp;
