...
**				Vol 62, pp 1129-1135.
**	Units		:	meters / second
**	Input		:	s (concentration units), t (deg C),
**				p (MPa)
**	Range		:	s ( 0.005 to 0.04 ), 
**                              t ( 0 to 40 ), 
**                              p ( 0 to 100 MPa )
**	Check values	:	svel( 0.035,  0., 10 ) = 1465.54
**				svel( 0.035, 10., 20 ) = 1522.96
**				svel( 0.035, 20., 30 ) = 1571.34
**				svel( 0.035, 30., 50 ) = 1628.97
**	Coded		:	Mark Prater, October 20, 1987
*/
...
double s;	/* salinity in concentration units */
double t;	/* temperature in deg. C */
double p;	/* pressure in MPa */

{

   double sqrt();
   double csvel, u_pure, del_u0, A, B, C;
...
b1  =  7.3637e-5,   b2  =  1.7945e-7,   c1  = -7.9836e-6;
   ...
   s = 1000. * s;    /* --- from salinity units to parts per thousand */
   ...
   csvel = u_pure + del_u0 + A*s + B*sqrt( s )*s + C*s*s; 
